...
class TGoogleCircle {
  ...
  factory TGoogleCircle.fromJson(Map<String, dynamic> json) {
    ...
    return TGoogleCircle(
      center: LatLng(double.parse(centerJson['latitude'].toString()), double.parse(centerJson['longitude'].toString())),
...
class TGoogleRectangle {
  ...
  factory TGoogleRectangle.fromJson(Map<String, dynamic> json) {
    ...
    return TGoogleRectangle(
      low: LatLng(double.parse(lowJson['latitude'].toString()), double.parse(lowJson['longitude'].toString())),
      high: LatLng(double.parse(highJson['latitude'].toString()), double.parse(highJson['longitude'].toString())),
    );
  }
}
...
class TGoogleLocationBias {
  ...
  factory TGoogleLocationBias.fromJson(Map<String, dynamic> json) {
    return TGoogleLocationBias(
      circle: json['circle'] != null ? TGoogleCircle.fromJson(json['circle'] as Map<String, dynamic>) : null,
      rectangle: json['rectangle'] != null ? TGoogleRectangle.fromJson(json['rectangle'] as Map<String, dynamic>) : null,
    );
  }
}
...
class TGooglePlacesConfig {
  ...
  Map<String, dynamic> toJson(String input) {
    final data = <String, dynamic>{'input': input};
    if (languageCode != null) data['languageCode'] = languageCode;
    if (regionCode != null) data['regionCode'] = regionCode;
    if (origin != null) {
      data['origin'] = {'latitude': origin!.latitude, 'longitude': origin!.longitude};
    }
...
class TGooglePredictionText {
  ...
  factory TGooglePredictionText.fromJson(Map<String, dynamic> json) {
    return TGooglePredictionText(text: json['text']?.toString() ?? '', matches: json['matches'] as List<dynamic>?);
  }
...
class TGoogleStructuredFormat {
  ...
  factory TGoogleStructuredFormat.fromJson(Map<String, dynamic> json) {
    return TGoogleStructuredFormat(
      mainText: json['mainText'] != null ? TGooglePredictionText.fromJson(json['mainText'] as Map<String, dynamic>) : null,
      secondaryText: json['secondaryText'] != null ? TGooglePredictionText.fromJson(json['secondaryText'] as Map<String, dynamic>) : null,
    );
  }
...
class TGooglePlacePrediction {
  ...
  const TGooglePlacePrediction({required this.place, required this.placeId, this.text, this.structuredFormat, this.types});
  ...
  factory TGooglePlacePrediction.fromJson(Map<String, dynamic> json) {
    ...
    return TGooglePlacePrediction(
      place: placeStr,
      placeId: placeIdStr,
      text: json['text'] != null ? TGooglePredictionText.fromJson(json['text'] as Map<String, dynamic>) : null,
...
class TGoogleQueryPrediction {
  ...
  Map<String, dynamic> toJson() => {if (text != null) 'text': text!.toJson(), if (query != null) 'query': query};
}
...
class TGoogleAutocompleteResponse {
  ...
  factory TGoogleAutocompleteResponse.fromJson(Map<String, dynamic> json) {
    ...
    return TGoogleAutocompleteResponse(suggestions: list.map((e) => TGoogleSuggestion.fromJson(e as Map<String, dynamic>)).toList());
  }

  Map<String, dynamic> toJson() => {'suggestions': suggestions.map((e) => e.toJson()).toList()};
}
...
class TGooglePlaceDetailsResponse {
  ...
  factory TGooglePlaceDetailsResponse.fromJson(Map<String, dynamic> json) {
    ...
    return TGooglePlaceDetailsResponse(
      ...
      location: loc,
      displayName: json['displayName'] != null ? TGooglePredictionText.fromJson(json['displayName'] as Map<String, dynamic>) : null,
      raw: json,
    );
  }
...
class TGoogleClient {
  ...
  static const List<String> widgetAutocompleteFieldMasks = [autocompletePlaceId, autocompletePlace, autocompletePlaceText];
  ...
  TGoogleClient({Dio? dio, String? googleMapApiKey}) : _dio = dio ?? Dio(), _googleMapApiKey = googleMapApiKey;
  ...
  Future<TGoogleAutocompleteResponse> autocomplete(
    ...
    final response = await _dio.post(
      ...
      data: data,
      options: Options(headers: {'X-Goog-Api-Key': apiKey, 'X-Goog-FieldMask': fieldMasks.join(','), 'Content-Type': 'application/json'}),
    );
  ...
  Future<TGooglePlaceDetailsResponse> fetchPlaceDetails(
    ...
    final response = await _dio.get(
      ...
      queryParameters: {if (sessionToken != null && sessionToken.isNotEmpty) 'sessionToken': sessionToken},
      options: Options(headers: {'X-Goog-Api-Key': apiKey, 'X-Goog-FieldMask': fields.join(',')}),
    );
