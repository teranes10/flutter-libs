...
class ProductDtoMapper extends ClassMapperBase<ProductDto> {
  ...
  static const Field<ProductDto, String> _f$description = Field('description', _$description);
  ...
  static const Field<ProductDto, num> _f$discountPercentage = Field('discountPercentage', _$discountPercentage);
  ...
  static const Field<ProductDto, String> _f$category = Field('category', _$category);
  ...
  static const Field<ProductDto, String> _f$thumbnail = Field('thumbnail', _$thumbnail, opt: true);
  static List<String>? _$images(ProductDto v) => v.images;
  static const Field<ProductDto, List<String>> _f$images = Field('images', _$images, opt: true);
  static MetaDto? _$meta(ProductDto v) => v.meta;
  static const Field<ProductDto, MetaDto> _f$meta = Field('meta', _$meta, opt: true);
...
mixin ProductDtoMappable {
  String toJson() {
    return ProductDtoMapper.ensureInitialized().encodeJson<ProductDto>(this as ProductDto);
  }

  Map<String, dynamic> toMap() {
    return ProductDtoMapper.ensureInitialized().encodeMap<ProductDto>(this as ProductDto);
  }

  ProductDtoCopyWith<ProductDto, ProductDto, ProductDto> get copyWith =>
      _ProductDtoCopyWithImpl<ProductDto, ProductDto>(this as ProductDto, $identity, $identity);
  @override
  String toString() {
    return ProductDtoMapper.ensureInitialized().stringifyValue(this as ProductDto);
  }

  @override
  bool operator ==(Object other) {
    return ProductDtoMapper.ensureInitialized().equalsValue(this as ProductDto, other);
  }
...
extension ProductDtoValueCopy<$R, $Out> on ObjectCopyWith<$R, ProductDto, $Out> {
  ProductDtoCopyWith<$R, ProductDto, $Out> get $asProductDto => $base.as((v, t, t2) => _ProductDtoCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ProductDtoCopyWith<$R, $In extends ProductDto, $Out> implements ClassCopyWith<$R, $In, $Out> {
...
class _ProductDtoCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, ProductDto, $Out>
    implements ProductDtoCopyWith<$R, ProductDto, $Out> {
  _ProductDtoCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ProductDto> $mapper = ProductDtoMapper.ensureInitialized();
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>>? get images =>
      $value.images != null ? ListCopyWith($value.images!, (v, t) => ObjectCopyWith(v, $identity, t), (v) => call(images: v)) : null;
  @override
  MetaDtoCopyWith<$R, MetaDto, MetaDto>? get meta => $value.meta?.copyWith.$chain((v) => call(meta: v));
  @override
  $R call({
    int? id,
    String? title,
  ...
  ProductDto $make(CopyWithData data) => ProductDto(
    ...
    discountPercentage: data.get(#discountPercentage, or: $value.discountPercentage),
  ...
  @override
  ProductDtoCopyWith<$R2, ProductDto, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
